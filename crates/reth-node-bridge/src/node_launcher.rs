...
use reth::{
    ...
    builder::{
        ...
        hooks::NodeHooks,
        BuilderContext, LaunchContext, LaunchNode, NodeAdapter, NodeAddOns,
...
// as the default not builder does not expose enough configuration for what we need
// ====================================
...
impl<T, CB> LaunchNode<NodeBuilderWithComponents<T, CB>> for CustomNodeLauncher
where
